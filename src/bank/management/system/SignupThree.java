...
import javax.swing.*;
import java.awt.*;
import java.awt.event.*; // for using ActionListener
import java.util.*;
...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        c7 = new JCheckBox("I hereby declares the above entered details are correct.");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == submit) {
            ...
            // Now to establish a connection with the database ->
            try {
